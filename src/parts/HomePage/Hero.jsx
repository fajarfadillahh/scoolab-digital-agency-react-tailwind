...
const Hero = () => {
  return (
    <section className="section relative pt-32 lg:pt-40">
      {/* gradient */}
      <div className="absolute -top-[100px] -left-[250px] h-[500px] w-[500px] rounded-full bg-gradient-to-t from-pink-600 to-yellow-200 blur-[130px] 2xl:-top-[50px] 2xl:h-[600px] 2xl:w-[600px]" />
