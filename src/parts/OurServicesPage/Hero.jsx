...
const Hero = () => {
  return (
    <section className="section relative pt-40">
      {/* gradient */}
      <div className="absolute -top-[40px] -left-[150px] h-[400px] w-[400px] rounded-full bg-gradient-to-t from-green-500 to-yellow-300 blur-[130px] 2xl:-bottom-[30px] 2xl:h-[600px] 2xl:w-[600px]" />
